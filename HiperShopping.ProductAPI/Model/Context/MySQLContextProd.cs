...
namespace HiperShopping.ProductAPI.Model.Context
{
    public class MySQLContextProd : DbContext
    {
        public MySQLContextProd() {}
        public MySQLContextProd(DbContextOptions<MySQLContextProd> options) : base(options) {}
